...
void sock_set_parent_span(uint64_t socket_cookie, uint64_t trace_id_hi, uint64_t trace_id_lo, uint64_t span_id, uint64_t tag_id)
{
	DTRACE_PROBE5(ebpf_exporter, sock_set_parent_span, socket_cookie, trace_id_hi, trace_id_lo, span_id, tag_id);
}
*/
import "C"
import (
